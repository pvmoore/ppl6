module ppl._2_parse.ParseLiteral;
...
public:
    ...
    void parseLiteralString(Tokens t, ASTNode parent) {
        ...
        var.type = findType.findType("string", parent);
        composite.add(var);
        ...
        if(t.kind() == TT.STRING && t.onSameLine()) {
    ...
    void parseLiteral(Tokens t, ASTNode parent) {
        ...
        if(t.kind() == TT.NUMBER || t.kind() == TT.CHAR || t.value() == "true" || t.value() == "false") {
